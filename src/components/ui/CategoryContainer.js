...
const CateoryContaner = ({ product, categoryName, id }) => {
  ...
  const products = ProductCTX?.items?.filter((el) => el.id === id);
  ...
  return (
    <Container>
      <StyledDIV>
        <div className="inner_wrapper">
          <div className="name_cat_wraper">
            ...
            {edit && (
              <div className="input_change_name">
                <input
                  type="text"
                  value={catName}
                      ...
                      <g id="tick" transform="translate(2.04 2.04)">
                        ...
                        >
                          <path
                            id="Path_1"
                            data-name="Path 1"
                            d="M17.372,32.745l11.3,11.3m0-11.3-11.3,11.3"
                            transform="translate(-17.372 -32.745)"
                            fill="none"
                            stroke="#212121"
                ...
                <button onClick={onSaveNameChangeHandler}>
                  <svg
                    ...
                    width="15.416"
                    height="15"
                    viewBox="0 0 15.416 15"
                  >
                    <g
                      id="Group_4"
                      data-name="Group 4"
                      transform="translate(0.017 -0.382)"
                    >
                      <rect
                        id="Rectangle_4"
                        ...
                        width="15"
                        height="15"
                        transform="translate(0.311 0.382)"
                        fill="none"
                      />
                      <g id="tick" transform="translate(1.397 3.378)">
                        ...
                        >
                          <path
                            id="Path_1"
                            data-name="Path 1"
                            d="M14.137,6.667l3.96,3.96L26.724,2"
                            transform="translate(-14.137 -2)"
                            fill="none"
                            stroke="#212121"
                            stroke-linecap="round"
                            stroke-linejoin="round"
            ...
            <button onClick={onEditNameBtnHandler} className="control_btn">
              ...
              >
                ...
                >
                  ...
                  <path
                    id="edit"
                    d="M23.634,2.853a3.741,3.741,0,0,1,0,5.291L9.817,21.961a4.676,4.676,0,0,1-2.173,1.23L3.359,24.262a.935.935,0,0,1-1.134-1.134L3.3,18.843a4.677,4.677,0,0,1,1.23-2.172L18.343,2.853A3.741,3.741,0,0,1,23.634,2.853ZM17.021,6.821,5.849,17.993a2.806,2.806,0,0,0-.738,1.3L4.418,22.07l2.773-.693a2.806,2.806,0,0,0,1.3-.738L19.666,9.466Zm2.646-2.645L18.343,5.5l2.645,2.645,1.323-1.322a1.871,1.871,0,1,0-2.645-2.645Z"
                    transform="translate(721.537 492.976)"
                    fill="#212121"
                  />
                </g>
              </svg>
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    transform="translate(686 490.26)"
                    fill="#212121"
                  />
                </g>
              </svg>
          ...
          <div className="btn_wraper">
            <button onClick={onAddPro}>محصول جدید</button>
          </div>
      ...
      {products[0]?.product?.map((el, i) => (
        <ProductInCategory key={i} {...el} />
      ))}
    </Container>
  );
};
